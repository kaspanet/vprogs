...
/// Decodes a wire buffer into zero-copy metadata and mutable account views.
///
...
pub fn decode_transaction_context(
    ...
    let tx_bytes_len = u32::from_le_bytes(buf[48..FIXED_HEADER_SIZE].try_into().unwrap()) as usize;
