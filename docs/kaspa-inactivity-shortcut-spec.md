...
For the single-rotation cases considered here, the §5.0–§5.6 structural arguments extend under the full §2.2 predicate `A.bs + min(F(A), F(B)) < B.bs`:
